<p align= center</p><a href="https://rdimo.github.io/CheatAway/" target="_blank"><img src="https://cdn.discordapp.com/attachments/853347983639052318/858485202157699092/FALLEGA_Nuker_Banner.png" alt="FALLEGANuker"></a>

### 2021-11-7, v1.3.3
* ` New option! Groupchat Spammer (suggestion from JayH4x (https://github.com/Rdimo/FALLEGA-Nuker/issues/18))`
...
* ` New setup to make it easier to start FALLEGA`
...
### 2021-10-16, v1.3.1
* ` New option! Create Stealer (https://github.com/Rdimo/FALLEGA-Token-Grabber-V2)`
...
* ` FALLEGA runs alot smoother now since I cleaned up the code`
...
* ` Made it more clear when FALLEGA Nuker fails to update`
...
* ` Made FALLEGA Nuker send an error to your webhook incase you get one (easier for me to debug and you can send me the errors)`
* ` Disabled logs when logging into an account`
* ` Option 9 is not disable account instead of disable token since disable token got patched (more info https://github.com/Rdimo/FALLEGA-Nuker#9-disable-account)`
...
* ` FALLEGA Nuker now downloads a chromedriver for you automatically`
...
Created by EL.D.O.B#7040| https://ELDOB.github.io/CheatAway
