# FALLEGA was proudly coded by EL.D.O.B (https://github.com/EL.D.O.B).
# FALLEGA Nuker under the GNU General Public Liscense v2 (1991).
...
def main():
    setTitle(f"FALLEGA Nuker {THIS_VERSION}")
    global threads
    threads = 0
    clear()
    #Main banner
    banner = Style.BRIGHT + f'''{Fore.LIGHTGREEN_EX}
                                                                                       ...
                                                                                       ██                          ██             ██                 ██                           ██                          █████████         ██                 ████                   ██                   ██
                                                                                       ██                        ██████████               ██                           ██                          ██                              ██                     ██                 ████████████
> Created by EL.D.O.B#7040                                         ██                     ██.                      ██            ██                           ██                          ██                               ██                    ██               ██                            ██
> https://discord.gg/yhHfTrRDMy                                ██                   ██                           ██          ████████          ████████         █████████               █████████              ██                               ██                 '''.replace('█', f'{Fore.WHITE}█{Fore.LIGHTGREEN_EX}') + f'''   
    ...
    if choice == '1':
        ...
        if r.status_code == 200:
            ...
            if threading.active_count() < threads:
                threading.Thread(target=util.accountNuke.FALLEGA_Nuke, args=(token, Server_Name, message_Content)).start()
                return
        else:
